package br.csi.ecommerce_livros_feliperighi.infra.security;
...
public class SecurityConfig {
    ...
    private final AutenticaoFilter autenticaoFilter;

    public SecurityConfig(AutenticaoFilter filtro){
